...
export default function ProgressPage() {
  ...
  return (
    <div className="container mx-auto space-y-4 md:space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      {/* Enhanced Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 md:gap-6">
        <PageHeader
        ...
        {isTrainer && (
          <div
            className="animate-in fade-in slide-in-from-right-3 duration-300 active:scale-[0.95] transition-transform"
          ...
          <Card className="relative overflow-hidden border border-border/30 bg-background/40 backdrop-blur-xl shadow-premium hover:shadow-premium-lg transition-all duration-500">
            ...
            <CardContent className="relative">
              <div className="flex gap-3 flex-wrap">
                {loadingClients ? (
                  <div className="text-muted-foreground/80 font-light animate-pulse">
                    Loading clients...
                  </div>
                ) : clients.length === 0 ? (
                  ...
                  (clients || []).map((client: Client, index: number) => (
                    <div
                      key={client.id}
                      className="animate-in fade-in zoom-in-95 duration-300 hover:-translate-y-0.5 active:scale-[0.95] transition-all"
          ...
          <Card className="glass-strong border-border/50 shadow-premium">
            <CardContent className="py-16 text-center">
              <div className="relative inline-block mb-6">
                ...
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary/10 to-transparent blur-xl animate-pulse" />
              </div>
              <div className="space-y-2">
      ...
      {isSolo && !loadingSoloProgress && (!soloProgress || soloProgress.totalWorkouts === 0) && (
        <div className="flex flex-col items-center justify-center py-20 space-y-6 text-center animate-in fade-in slide-in-from-bottom-1 duration-300">
      ...
      {isSolo && !loadingSoloProgress && soloProgress && soloProgress.totalWorkouts > 0 && (
        <div className="space-y-6">
          {/* Stats Cards */}
          <div
            className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 animate-in fade-in duration-300"
            style={{ animationDelay: '100ms', animationFillMode: 'backwards' }}
          >
                      ...
                      (() => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-muted-foreground/60 ml-1">vs prev week</span>
                          </span>
                        );
                      })()}
                  </div>
                      ...
                      (() => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {Math.abs(pct).toFixed(0)}%
                            <span className="text-muted-foreground/60 ml-1">vs prev session</span>
                          </span>
                        );
                      })()}
                  </div>
          ...
          {trainingLoadRatio && (
            <div
              className="animate-in fade-in duration-300"
              style={{ animationDelay: '170ms', animationFillMode: 'backwards' }}
            >
              <Card className="border-border/30 bg-background/40 backdrop-blur-xl overflow-hidden">
      ...
      {selectedClientData && !loadingProgress && progressTypes.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 space-y-4 text-center animate-in fade-in slide-in-from-bottom-1 duration-300">
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {progressTypes.map((type, index) => {
              ...
              return (
                <div
                  key={type}
                  className="animate-in fade-in duration-300 hover:-translate-y-1 transition-transform"
                  style={{
          ...
          >
            <Card className="group relative overflow-hidden border border-border/30 bg-background/40 backdrop-blur-xl shadow-premium-lg hover:shadow-premium-xl transition-all duration-500">
              ...
              <CardContent className="relative">
                {loadingProgress ? (
                  <div className="text-center py-12 text-muted-foreground/80 font-light animate-pulse">
                    ...
                    {(progressData || [])
                      ...
                      .map((entry: ProgressEntry, index: number) => {
                        ...
                        return (
                          <div
                            key={entry.id}
                            className="relative pl-16 animate-in fade-in slide-in-from-left-3 duration-300"
                            style={{
                          ...
                          >
                            {/* Timeline dot */}
                            <div className="absolute left-4 top-6 w-5 h-5 rounded-full border-2 border-primary bg-primary/20 flex items-center justify-center hover:opacity-80 transition-opacity duration-300">
                              <div className="w-2 h-2 rounded-full bg-primary" />
                            </div>

                            <div className="group/card relative overflow-hidden rounded-xl border border-border/30 hover:border-primary/40 bg-background/60 backdrop-blur-sm p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:translate-x-1">
                              ...
                              <div className="relative flex items-start justify-between gap-4">
                                <div className="flex items-start gap-4 flex-1">
                                  {/* Icon */}
                                  <div className="p-3 rounded-lg bg-gradient-to-br from-primary/20 to-primary/10 border border-primary/20 hover:rotate-[5deg] transition-transform duration-300">
                                ...
                                {index < (progressData || []).length - 1 &&
                                  (() => {
                                    ...
                                    if (prevEntry) {
                                      ...
                                      return (
                                        <div
                                          className={`flex items-center gap-1 px-2 py-1 rounded-lg animate-in zoom-in-95 duration-300 ${
                                            isPositive
                  ...
                  <div className="text-center py-16 space-y-6">
                    <div className="relative inline-block">
                      ...
                      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary/10 to-transparent blur-2xl animate-pulse" />
                    </div>
                    <div className="space-y-2">
