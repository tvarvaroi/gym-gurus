    ...
    <TooltipProvider delayDuration={0}>
      <Sidebar collapsible="icon" className="border-r border-border/50 bg-sidebar/95 backdrop-blur-xl">
        <SidebarContent className="pt-8">
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(201, 168, 85, 0.3), rgba(13, 148, 136, 0.3))',
                      filter: 'blur(2px)',
                    }}
                  />
                  <div
          ...
          <SidebarGroupLabel className={`mb-4 md:mb-8 ${isCollapsed ? 'hidden' : 'px-2 md:px-4'}`}>
            <motion.div
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        ...
                        >
                          ...
                          >
                            <a href={item.url} data-testid={`link-${item.title.toLowerCase().replace(' ', '-')}`} className={`flex items-center w-full ${isCollapsed ? 'justify-center !px-0' : 'gap-3 px-4'}`}>
                              <motion.div
