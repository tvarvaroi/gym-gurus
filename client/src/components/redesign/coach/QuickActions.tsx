...
const CHIPS = [
  ...
  },
  {
    icon: Apple,
    label: 'Nutrition',
    prompt: 'What should I eat before and after my workout?',
    color: 'text-green-400 border-green-500/30 bg-green-500/10',
  },
  {
    icon: Moon,
    label: 'Recovery',
    prompt: 'How can I optimize my recovery between workouts?',
            ...
            {CHIPS.map((chip) => {
              ...
              return (
                <button
                  ...
                  className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-full border text-xs font-medium transition-colors active:scale-95 ${chip.color}`}
                >
