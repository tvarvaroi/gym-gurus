...
export class MemoryStorage implements IStorage {
  ...
  constructor() {
    if (process.env.NODE_ENV === 'production') {
      throw new Error(
        'MemoryStorage instantiated in production — this should never happen. ' +
          'All data would be lost on restart. Check DATABASE_URL configuration.'
      );
    }
  ...
  private initializeMockData() {
    ...
    const defaultExercises: Exercise[] = [
      // === COMPOUND LIFTS ===
      {
        ...
        description: 'The king of lower body exercises. Builds quad, glute, and core strength.',
        category: 'strength',
        ...
        instructions: [
          ...
          'Unrack and step back, brace your core',
          'Lower by bending knees and hips until thighs are parallel',
      ...
      },
      {
        ...
        description: 'Full posterior chain compound lift. Builds total body strength.',
        category: 'strength',
        difficulty: 'intermediate',
        ...
        instructions: [
          ...
          'Lock out at the top, then reverse the movement',
        ],
      ...
      },
      {
        ...
        description: 'Primary chest pressing movement for upper body strength.',
        category: 'strength',
        difficulty: 'intermediate',
      ...
      },
      {
        id: 'exercise-4',
        name: 'Overhead Press',
        description: 'Standing shoulder press for overhead pressing strength.',
        category: 'strength',
        difficulty: 'intermediate',
      ...
      },
      {
        id: 'exercise-5',
        name: 'Barbell Row',
        description: 'Horizontal pulling movement for a thick, strong back.',
        category: 'strength',
        difficulty: 'intermediate',
      ...
      },
      {
        id: 'exercise-7',
        name: 'Dumbbell Fly',
        description: 'Chest isolation exercise focusing on the stretch and squeeze.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['chest'],
        ...
        instructions: [
          ...
          'Lower dumbbells in a wide arc with slight elbow bend',
      ...
      },
      {
        id: 'exercise-8',
        name: 'Push-up',
        description: 'Classic bodyweight chest exercise. Great for endurance and warmups.',
        category: 'strength',
        difficulty: 'beginner',
      ...
      },
      {
        ...
        instructions: [
          ...
          'Squeeze chest hard at the contracted position',
        ],
        youtubeUrl: null,
        exerciseType: 'weighted_reps',
        defaultSets: 3,
      ...
      // === BACK ===
      {
        id: 'exercise-10',
        name: 'Pull-up',
        description: 'The ultimate bodyweight back exercise for lat width.',
        category: 'strength',
        difficulty: 'intermediate',
      ...
      },
      {
        id: 'exercise-11',
        name: 'Lat Pulldown',
        description: 'Machine-based lat exercise, great for all levels.',
        category: 'strength',
        difficulty: 'beginner',
        ...
        instructions: [
          ...
          'Control the weight back up with a stretch',
        ],
        youtubeUrl: null,
        exerciseType: 'weighted_reps',
        defaultSets: 3,
      ...
      },
      {
        ...
        description: 'Horizontal pulling for back thickness and posture.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['back', 'biceps', 'rear delts'],
        equipment: ['cable machine'],
        instructions: [
          ...
          'Grip the handle, arms extended',
          'Pull handle to your abdomen, squeezing shoulder blades',
          'Return with control, letting lats stretch',
        ],
        youtubeUrl: null,
        exerciseType: 'weighted_reps',
        defaultSets: 3,
      ...
      },
      {
        ...
        instructions: [
          ...
          'Hold dumbbell in the other hand, arm hanging',
          'Row dumbbell up to your hip',
      ...
      },
      {
        ...
        instructions: [
          ...
          'Pull rope towards your face, spreading the rope apart',
      ...
      // === ARMS ===
      {
        id: 'exercise-17',
        name: 'Barbell Curl',
        description: 'Classic biceps builder for peak arm size.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['biceps'],
        equipment: ['barbell'],
        instructions: [
          ...
          'Curl bar up by flexing at the elbows',
          'Squeeze biceps at the top',
          'Lower with control, keeping elbows pinned',
        ],
        youtubeUrl: null,
        exerciseType: 'weighted_reps',
        defaultSets: 3,
      ...
      },
      {
        id: 'exercise-18',
        name: 'Hammer Curl',
        description: 'Targets the brachialis and forearms for thick arms.',
        category: 'strength',
        difficulty: 'beginner',
      ...
      },
      {
        id: 'exercise-21',
        name: 'Dip',
        description: 'Bodyweight exercise for chest, triceps, and shoulders.',
        category: 'strength',
        difficulty: 'intermediate',
      ...
      // === LEGS ===
      {
        id: 'exercise-22',
        name: 'Front Squat',
        description: 'Quad-dominant squat variation with an upright torso.',
        category: 'strength',
        difficulty: 'advanced',
        ...
        instructions: [
          ...
          'Squat down until thighs are below parallel',
      ...
      },
      {
        ...
        description: 'Hamstring and glute builder focusing on the hip hinge.',
        category: 'strength',
        difficulty: 'intermediate',
        ...
        instructions: [
          ...
          'Feel a deep stretch in hamstrings',
      ...
      },
      {
        id: 'exercise-25',
        name: 'Leg Press',
        description: 'Machine-based quad and glute exercise with heavy load capacity.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['quadriceps', 'glutes', 'hamstrings'],
        ...
        instructions: [
          ...
          'Push platform back until legs are nearly straight',
      ...
      },
      {
        id: 'exercise-27',
        name: 'Leg Extension',
        description: 'Quad isolation exercise for muscle definition.',
        category: 'strength',
        difficulty: 'beginner',
      ...
      },
      {
        id: 'exercise-29',
        name: 'Walking Lunge',
        description: 'Dynamic leg exercise for strength and coordination.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['quadriceps', 'glutes', 'hamstrings'],
        equipment: ['dumbbells'],
      ...
      },
      {
        id: 'exercise-30',
        name: 'Hip Thrust',
        description: 'Top glute builder. Essential for posterior chain.',
        category: 'strength',
        difficulty: 'intermediate',
      ...
      },
      {
        ...
        description: 'Challenging core exercise for total ab development.',
        category: 'strength',
        difficulty: 'advanced',
        muscleGroups: ['core', 'shoulders'],
        equipment: ['ab wheel'],
        instructions: [
          ...
          'Go as far as you can maintain control',
          'Pull back to starting position using your core',
        ],
        youtubeUrl: null,
        exerciseType: 'bodyweight_reps',
        defaultSets: 3,
      ...
      },
      {
        id: 'exercise-35',
        name: 'Russian Twist',
        description: 'Oblique-focused rotational core exercise.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['core', 'obliques'],
        equipment: ['bodyweight'],
      ...
      },
      {
        id: 'exercise-37',
        name: 'Rowing Machine',
        description: 'Full-body cardio that builds back and leg endurance.',
        category: 'cardio',
        difficulty: 'beginner',
        ...
        instructions: [
          ...
          'Push with legs first, then lean back and pull',
          'Reverse the motion: arms, body, legs',
      ...
      },
      {
        id: 'exercise-38',
        name: 'Jump Rope',
        description: 'High-intensity cardio for coordination and conditioning.',
        category: 'cardio',
        difficulty: 'beginner',
        ...
        instructions: [
          ...
          'Jump with both feet, just clearing the rope',
      ...
      },
      {
        id: 'exercise-39',
        name: 'Battle Ropes',
        description: 'Upper body and conditioning exercise with metabolic demand.',
        category: 'cardio',
        difficulty: 'intermediate',
        ...
        instructions: [
          ...
          'Alternate arms making waves in the ropes',
          'Maintain high intensity for the prescribed time',
        ],
        youtubeUrl: null,
        exerciseType: 'cardio_time',
        defaultSets: 4,
      ...
      },
      {
        ...
        instructions: [
          ...
          'Let gravity bring it back and repeat',
        ],
        youtubeUrl: null,
        exerciseType: 'weighted_reps',
        defaultSets: 4,
      ...
      // === FLEXIBILITY / MOBILITY ===
      {
        ...
        description: 'Dynamic full-body mobility drill.',
        ...
        instructions: [
          ...
          'Place left hand on floor, rotate right arm to ceiling',
      ...
      },
      {
        ...
        instructions: [
          ...
          'Drop belly toward floor and look up like a cow (inhale)',
      ...
      },
      {
        id: 'exercise-46',
        name: 'Pigeon Stretch',
        description: 'Deep hip opener targeting the glutes and hip flexors.',
        category: 'flexibility',
        difficulty: 'beginner',
      ...
      },
      {
        ...
        description: 'Self-myofascial release for the outer thigh.',
        category: 'flexibility',
        difficulty: 'beginner',
      ...
      // === FUNCTIONAL / FULL BODY ===
      {
        id: 'exercise-48',
        name: 'Turkish Get-Up',
        description: 'Complex full-body exercise for stability and coordination.',
        category: 'strength',
        difficulty: 'advanced',
        ...
        instructions: [
          ...
          'Follow the step-by-step sequence to stand up',
          'Keep the bell locked out overhead throughout',
          'Reverse steps to return to lying position',
        ],
        youtubeUrl: null,
        exerciseType: 'weighted_reps',
        defaultSets: 3,
      ...
      },
      {
        id: 'exercise-49',
        name: "Farmer's Walk",
        description: 'Grip, core, and total body conditioning exercise.',
        category: 'strength',
        difficulty: 'beginner',
      ...
      },
      {
        id: 'exercise-50',
        name: 'Goblet Squat',
        description: 'Beginner-friendly squat variation with great form cues.',
        category: 'strength',
        difficulty: 'beginner',
        muscleGroups: ['quadriceps', 'glutes', 'core'],
        equipment: ['dumbbell'],
        instructions: [
          ...
          'Squat down keeping the weight close to chest',
          'Push knees out and keep torso upright',
      ...
      },
      {
        ...
        description: 'Olympic-style compound movement for power.',
        category: 'strength',
        difficulty: 'advanced',
        ...
        instructions: [
          ...
          'Pull bar explosively to shoulder height (clean)',
      ...
      },
      {
        id: 'exercise-52',
        name: 'Thruster',
        description: 'Front squat into overhead press for full body conditioning.',
        category: 'strength',
        difficulty: 'intermediate',
  ...
  async getTrainerAnalytics(trainerId: string) {
    ...
    const thisMonthCompleted = allAssignments.filter(
      (a) =>
        new Date(a.assignedAt) >= startOfMonth &&
        (a.completedAt != null || a.status === 'completed')
    );

    const trainerWorkouts = Array.from(this.workouts.values()).filter(
      (w) => w.trainerId === trainerId
    );
    const avgDuration =
